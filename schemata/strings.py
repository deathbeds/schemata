...
class Pattern(Any.from_key("pattern")):
    @utils.validates(str)
...
class MinLength(Any.from_key("minLength")):
    @utils.validates(str)
    def validator(cls, object):
...
class MaxLength(Any.from_key("maxLength")):
    @utils.validates(str)
    def validator(cls, object):
...
class Uuid(formats.Uuid, String):
...
class JsonPointer(formats.JsonPointer, String):
...
class DateTime(formats.DateTime, String):
